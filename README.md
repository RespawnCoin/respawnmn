# Respawn Masternode Install Script
...
4. Send 7000 RSP to this address
...
```<alias> <ip>:5600 <private_key> <tx_id> <index>```
4. It should look something like this:
``` mn1 127.0.0.2:5600 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0```
...
3. Enter ```respawn-cli masternode status```
